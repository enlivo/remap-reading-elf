...
export default function BlogMobileNavigation() {
  ...
  return (
    <div className="mobile-landing-navigation blog-mobile-navigation">
      <button
        ref={triggerRef}
        type="button"
        ...
        aria-controls="blog-mobile-navigation-drawer"
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.aside
              ref={panelRef}
              id="blog-mobile-navigation-drawer"
