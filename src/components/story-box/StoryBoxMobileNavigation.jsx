...
export default function StoryBoxMobileNavigation() {
  ...
  return (
    <div className="mobile-landing-navigation mobile-story-box-navigation">
      <button
        ref={triggerRef}
        type="button"
        ...
        aria-controls="story-box-mobile-navigation-drawer"
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.aside
              ref={panelRef}
              id="story-box-mobile-navigation-drawer"
