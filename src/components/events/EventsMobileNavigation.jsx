...
export default function EventsMobileNavigation() {
  ...
  return (
    <div className="mobile-landing-navigation events-mobile-navigation">
      <button
        ref={triggerRef}
        type="button"
        ...
        aria-controls="events-mobile-navigation-drawer"
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.aside
              ref={panelRef}
              id="events-mobile-navigation-drawer"
