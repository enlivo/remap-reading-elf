...
export default function OurStoryMobileNavigation() {
  ...
  return (
    <div className="mobile-landing-navigation our-story-mobile-navigation">
      <button
        ref={triggerRef}
        type="button"
        ...
        aria-controls="our-story-mobile-navigation-drawer"
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.aside
              ref={panelRef}
              id="our-story-mobile-navigation-drawer"
